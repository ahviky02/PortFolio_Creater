...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image26": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/chevron-forward-outline.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image27": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/chevron-back-outline.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image31": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/arrow-forward-circle-sharp.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox78": {
      "custom": {
        "text": "How to build rapport with your web design clints"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox81": {
      "custom": {
        "text": "Top 6 free website mock up tools 2021"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox84": {
      "custom": {
        "text": "Logo design tyrends to avoid in 2021"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox88": {
      "custom": {
        "text": " That's me! Over the past 12 years, I've worked with a diverse range of clients, from startups to Fortune 500 companies. I love crafting interfaces that delight users and help businesses grow."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox97": {
      "custom": {
        "text": "Msc(human Computer Interraction"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox103": {
      "custom": {
        "text": "Bsc in Software EngiEngineering  "
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox104": {
      "custom": {
        "text": "California State Unuversity"
      },
      "callbacks": {
        "onClick": [
          {
